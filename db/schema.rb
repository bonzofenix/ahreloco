...
ActiveRecord::Schema.define(:version => 20130422003720) do
  ...
  add_index "beta_users", ["email"], :name => "index_beta_users_on_email", :unique => true
  add_index "beta_users", ["username"], :name => "index_beta_users_on_username", :unique => true
